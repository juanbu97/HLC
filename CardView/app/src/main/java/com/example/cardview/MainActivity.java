...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializeData(){
        ...
        pintores.add(new Pintores("Vasili Kandinski", "Vasili Vasílievich Kandinski fue un pintor ruso, precursor del arte abstracto en pintura y teórico del arte. Se considera que con él comienzan la abstracción lírica y el expresionismo", R.drawable.kandinsky));
